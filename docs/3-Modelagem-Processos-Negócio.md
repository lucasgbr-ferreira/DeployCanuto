...
Proposta de Solução:
A solução proposta é a criação de um sistema back-end que automatize e integre os processos de registro e venda de veículos. A modelagem TO BE (com base nos seus diagramas de referência) sugere a unificação desses processos em uma plataforma digital.
...
•	Indisponibilidade de tratar a troca de documentos: Devido a trâmites burocráticos a intermediação de documentos é inviável pelo mesmo motivo de ser dados sensíveis e de difícil acesso.
